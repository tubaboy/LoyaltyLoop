                    ...
                    <CardContent className="p-6 flex flex-col h-full gap-6">
                        <div>
                            ...
                            <div className="flex gap-2">
                                <div className="flex-1 min-w-0 overflow-hidden text-4xl font-mono p-4 bg-gray-50 rounded-md border text-center text-foreground min-h-[5.5rem] flex items-center justify-center capitalize gap-1">
